...
DATA_PRODUCTS = {
    ...
    "landsat_etm_c2_l1":[ "5e83d0d0d2aaa488", "5e83d0d08fec8a66", "5e83d0a0f94d7d8d"],
    "landsat_ot_c2_l1": ["5e81f14ff4f9941c", "5e81f14f92acf9ef"],
    "landsat_mss_c2_l1": ["5e83d0e09a752cff", "5e83d0a05ee25348","5e83a358acceddc0", "5e83a34c3f33c396", "5f64fd5131ca1b4c" ],
    # Level 2 datasets
...
class EarthExplorer(object):
    ...
    def _download(
        self, url, output_dir, timeout, chunk_size=1024, skip=False, overwrite=False, success=False, justcheck = False
    ):
        ...
        try:
            ...
            return local_filename, success #add
        ...
        for id_count, dataset_id in enumerate(dataset_id_list):
            try:
                ...
                filename = self._download(
                    url, output_dir, timeout=timeout, skip=skip, overwrite=overwrite, success=True, justcheck=justcheck
                )
